...
describe('Lab preset contracts', () => {
  ...
  it('all example presets compile and diagnose without errors in default mode', () => {
    const presets: [string, SchematicDocument, 'dcOp' | 'tran' | 'ac'][] = [
      ...
      ['seriesParallel', createSeriesParallelPreset(), 'dcOp'],
      ['seriesLeds', createSeriesLedsPreset(), 'dcOp'],
      ...
      ['halfWave', createHalfWavePreset(), 'tran'],
      ['bridge', createBridgePreset(), 'tran'],
      ['filterCap', createFilterCapPreset(), 'tran'],
      ['zener', createZenerPreset(), 'dcOp'],
      ['vreg7805', createVreg7805Preset(), 'dcOp'],
      ['reversePolarity', createReversePolarityPreset(), 'dcOp'],
      ['fuseProtect', createFuseProtectPreset(), 'dcOp'],
      ['ripple', createRipplePreset(), 'tran'],
      ['buck', createBuckPreset(), 'tran'],
      ['boost', createBoostPreset(), 'tran'],

...
/**
 * Ripple measurement: half-wave + filter + load; probe JT vs gnd in Transient.
 * Smaller C / heavier load → more visible ripple.
 */
export function createRipplePreset(): SchematicDocument {
  resetIdSeq(170);
  const ac = createComponent('ac_source', 100, 180, 'AC1');
  ac.params = { mag: 12, phase: 0, freq: 50 };
  ...
  c1.params = { c: 47e-6, vmax: 25 };
  c1.rotation = 90;
  const r1 = createComponent('resistor', 520, 180, 'R1');
  r1.params = { r: 470 };
  r1.rotation = 90;

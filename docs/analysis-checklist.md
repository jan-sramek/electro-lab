...
| Auth & identity | Deferred but designed-for | done | [ADR-003](adr/003-auth-deferred.md), [risks-and-deferrals.md](risks-and-deferrals.md) |
...
| Privacy & compliance | Minors, GDPR if EU traffic grows | planned | [risks-and-deferrals.md](risks-and-deferrals.md) — phase C gate |

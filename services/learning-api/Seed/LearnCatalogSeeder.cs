...
public static class LearnCatalogSeeder
{
    ...
    [
        "adc-dac/pwm-pseudo-dac",
        "basics/ac-dc",
        "basics/led-fade",
        "basics/pulse-rc",
        "buses/i2c-multi-slave",
        "buses/spi-vs-i2c",
        "digital/debounce-idea",
        "filters/ac-rc-lpf",
        "filters/band-pass",
        "filters/bode-intuition",
        "filters/measure-freq-amp",
        "filters/notch-filter",
        "filters/rlc-series",
        "industrial/control-24v",
        "industrial/estop-principle",
        "motors/h-bridge",
        "motors/motor-direction",
        "opamps/opamp-active-filter",
        "opamps/opamp-differentiator",
        "opamps/opamp-integrator",
        "opamps/opamp-schmitt",
        "opamps/opamp-summing",
        "power/boost-converter",
        "power/buck-converter",
        "power/ripple-measure",
        "sensors/sensor-threshold",
        "switching/bjt-vs-mos-compare",
        "timing/ne555-play"
    ];
    ...
    [
        ...
        new("input", "learn.module.input.title", 3),
        new("timing", "learn.module.timing.title", 4),
        new("actuators", "learn.module.actuators.title", 5),
        new("sensors", "learn.module.sensors.title", 6),
        new("digital", "learn.module.digital.title", 7),
        new("motors", "learn.module.motors.title", 8),
        new("power", "learn.module.power.title", 9),
        new("filters", "learn.module.filters.title", 10),
        new("opamps", "learn.module.opamps.title", 11),
        new("industrial", "learn.module.industrial.title", 12),
        new("adc-dac", "learn.module.adcDac.title", 13),
        new("mcu", "learn.module.mcu.title", 14),
        new("buses", "learn.module.buses.title", 15),
        new("comms", "learn.module.comms.title", 16),
    ];
    ...
    [
        ...
        new("basics", "circuit-elements", "led", "learn.project.circuitElements", 1,
            StandardLessons("learn.project.circuitElements"), LongQuiz("learn.project.circuitElements", ["a", "b", "a", "a", "b", "a", "c", "b", "a", "c", "a", "b", "a", "c", "a", "b", "a", "c"]),
            NoLab()),
        ...
        new("basics", "voltage-divider", "voltageDivider", "learn.project.voltageDivider", 7,
        ...
        new("basics", "divider-design", "voltageDivider", "learn.project.dividerDesign", 8,
            StandardLessons("learn.project.dividerDesign"), StandardQuiz("learn.project.dividerDesign"),
            DcSimOk("learn.project.dividerDesign")),
        new("basics", "pot-divider", "pot", "learn.project.potDivider", 9,
